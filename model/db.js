...
const db = {
  ...
  projects: [
    { id: 1, nome: 'Projeto Exemplo', clienteId: 1, dataInicio: '2025-11-01', dataFim: '2025-11-06', dataPrevisao: '2026-01-15', valorCobrado: 1250, estaPago: 'sim', statusProjeto: 'Em andamento', descricao: 'Descrição do projeto exemplo.' }
  ]
};
